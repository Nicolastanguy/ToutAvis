...
public class SocialNetwork {
	...
	/**
	 * Obtenir le nombre d'avis laissés sur un produit
	 * 
	 ...
	 */
	private Collection<Membre> membre = new java.util.ArrayList();
	 ...
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="socialNetwork:avis.Item"
	 */
	 ...
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="socialNetwork:avis.IHM"
	 */
	private IHM ihm = new avis.IHM();
